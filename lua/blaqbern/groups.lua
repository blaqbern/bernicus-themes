...
function M.setup(name)
	local palette = require("palatte." .. name)
	...
	-- local str_alt = palette.green.bright
	local accent1 = palette.cyan.normal
	local accent1_alt = palette.cyan.bright
	-- local accent2 = palette.yellow.normal
	-- local accent2_alt = palette.yellow.bright
	local accent3 = palette.magenta.normal
	local accent3_alt = palette.magenta.bright
	-- local accent4 = palette.red.normal
	-- local accent4_alt = palette.red.bright
	...
	return {
		...
		PmenuSel = { fg = keyword_alt, bg = bg_dark2, style = "bold"},
		PmenuThumb = { bg = muted },
		...
		CursorLine = { bg = bg },
		CursorLineNr = { fg = accent1_alt, bg = bg_dark2, style = "bold" },
		VertSplit = { fg = bg, bg = bg },
		SignColumn = { bg = bg_dark2 },
		Title = { fg = accent3_alt, style = "bold" },
		Normal = { fg = fg, bg = bg },
		NonText = { fg = bg_dark3 },
		String = { fg = str },
